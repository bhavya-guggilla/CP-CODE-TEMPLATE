...
Includes fast I/O, modular arithmetic, number theory, array/prefix utilities, DSU, grid traversal, Bit Manipulation, a random test-case generator, and a built-in debug logger you can toggle on/off.
